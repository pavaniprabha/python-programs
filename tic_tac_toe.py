...
for key in theBoard:
    board_keys.append(key)          #append() adds an item to the end of the list. It appends an element by modifying the list.
...
def game():
    ...
    for i in range(10):
        printBoard(theBoard)
        print("It's your turn ," + turn + " Move to the place which you want? ")
        ...
        if count >= 5:
         try:
            if theBoard['7'] == theBoard['8'] == theBoard['9'] != ' ': # across the bottom
                ...
                print(" **** " +turn + " won. ****")
                break
            elif theBoard['1'] == theBoard['4'] == theBoard['7'] != ' ': # across left side corner
                printBoard(theBoard)
                print("\nGame Over.\n")                
                print(" **** " +turn + " won. ****")
                break
                ...
                print(" **** " +turn + " won. ****")
                break
            elif theBoard['3'] == theBoard['6'] == theBoard['9'] != ' ': # across right side corner 
                printBoard(theBoard)
                print("\nGame Over.\n")                
                print(" **** " +turn + " won. ****")
                break 
